...
import SectionWorld from './components/SectionWorld.jsx';
import ScrollManager from './components/ScrollManager.jsx';
import AccessibilityHints from './components/AccessibilityHints.jsx';
...
export default function App() {
  ...
  const looped = useMemo(() => [...worlds, ...worlds], [worlds]);
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <ScrollManager
        ...
        getSectionWidth={() => {
          ...
          if (!el) return 1;
          return el.scrollWidth / 2; // duplicated
        }}
      >
        <div id="reel-track" ref={trackRef} className="flex h-full">
          {looped.map((w, i) => (
